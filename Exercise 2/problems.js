window.answers = () => {
    ...
    let output = false // just assigning this output variable to be false 
    ...
    // 3 steps of the for loop - define iterator (i = 1) THEN define how many iterations you want to do (10 in this case) THEN how many times you are going to increase the iterator
    // i = i + 1 which is the same as i+=1
    //i = i + 4 which is the same as i+=4
    for (let i = 1; i < 11; i++) {
        console.log(i)
    }
    ...
    let sum = 0
    // For loop goes here: 
    // sum += i IT WOULD MEAN THE SAME AS sum = sum + i
    for (let i = 0; i < 100; i++) {
        sum = sum + i 
    }
