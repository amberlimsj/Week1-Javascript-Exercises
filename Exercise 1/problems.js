window.answers = () => {
    ...
    // we can't use const because const doesnt edit this value anymore... it's like fixed, so we have to use let
    let sheepCount = 0
    ...
    let a3 = 4 + 6 + "1"
    //let a4 = "102" - 1
    //let a5 = 10 * 10 + 1 --- this is because it is not a string, gives you 101 but not a string
    let a6 = "" + 202 / 2
    let a7 = 1 + "0" + 1
    //let a8 = 10 * (10 + "1")
